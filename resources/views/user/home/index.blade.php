                                    ...
                                    <div class="product-carousel-group">
                                        <div class="mirora-product">
                                            <div class="product-img">
                                                <img src="{{ asset('storage/'.$item->image) }}" alt="Product" class="primary-image" />
                                                    @foreach($item->image_detail as $item1)
                                                        <img src="{{ asset('storage/'.$item1) }}" alt="Product" class="secondary-image" />
                                                    @endforeach
                                            </div>

                                            <div class="product-content text-center">
                                                @foreach($brands as $item_brand)
                                                    @if($item_brand->id == $item->id_brand)
                                                        <span>{{ $item_brand->name }}</span>
                                                    @endif
                                                @endforeach
                                                <h4><a href="{{ route('product.detail', ['id'=>$item->id]) }}">{{ $item->name }}</a></h4>
                                                <div class="product-price-wrapper"><span class="money">{{ number_format($item->price) }} VNĐ</span></div>
                                            </div>
