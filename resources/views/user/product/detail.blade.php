                        ...
                        <div class="tab-content product-details-thumb-large" id="myTabContent-3">
                            <div class="tab-pane fade show active" id="product-large-one">
                                <div class="product-details-img easyzoom"><a class="popup-btn"
                                                                               href="user/img/products/3-900x900.jpg"><img
                                            src="user/img/products/3-900x900.jpg" alt="product"></a></div>
                            </div>
                            <div class="tab-pane fade" id="product-large-two">
                                <div class="product-details-img easyzoom"><a class="popup-btn"
                                                                             href="user/img/products/4-900x900.jpg"><img
                                            src="user/img/products/4-900x900.jpg" alt="product"></a></div>
                            </div>
                            <div class="tab-pane fade" id="product-large-three">
                                <div class="product-details-img easyzoom"><a class="popup-btn"
                                                                             href="user/img/products/5-900x900.jpg"><img
                                            src="user/img/products/5-900x900.jpg" alt="product"></a></div>
                            </div>
                            <div class="tab-pane fade" id="product-large-four">
                                <div class="product-details-img easyzoom"><a class="popup-btn"
                                                                             href="user/img/products/6-900x900.jpg"><img
                                            src="user/img/products/6-900x900.jpg" alt="product"></a></div>
                            </div>
                            <div class="tab-pane fade" id="product-large-five">
                                <div class="product-details-img easyzoom"><a class="popup-btn"
                                                                             href="assets/img/products/10-900x900.jpg"><img
                                            src="assets/img/products/10-900x900.jpg" alt="product"></a></div>
                            </div>
                        </div><!-- Tab Content End -->
                        ...
                        <div class="product-details-thumbnail">
                            <div class="thumb-menu product-details-thumb-menu nav-vertical-center"
                                ...
                                <div class="thumb-menu-item"><a href="#product-large-one" data-toggle="tab"
                                                                class="nav-link active"><img src="user/img/products/3-450x450.jpg"
                                                                                             alt="product thumb"></a></div>
                                <div class="thumb-menu-item"><a href="#product-large-two" data-toggle="tab"
                                                                class="nav-link"><img src="user/img/products/4-450x450.jpg"
                                                                                      alt="product thumb"></a></div>
                                <div class="thumb-menu-item"><a href="#product-large-three" data-toggle="tab"
                                                                class="nav-link"><img src="user/img/products/5-450x450.jpg"
                                                                                      alt="product thumb"></a></div>
                                <div class="thumb-menu-item"><a href="#product-large-four" data-toggle="tab"
                                                                class="nav-link"><img src="user/img/products/6-450x450.jpg"
                                                                                      alt="product thumb"></a></div>
                                <div class="thumb-menu-item"><a href="#product-large-five" data-toggle="tab"
                                                                class="nav-link"><img src="user/img/products/10-450x450.jpg"
                                                                                      alt="product thumb"></a></div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-details-content">
                            <div class="product-details-top">
                                ...
                                <div class="ratings-wrap">
                                    <div class="ratings"><i class="fa fa-star rated"></i><i
                                            ...
                                            class="fa fa-star"></i><i class="fa fa-star"></i></div><span><a
                                            class="review-btn" href="#singleProductTab">1 Reviews</a><a
                                            class="review-btn" href="#singleProductTab">write a
                                                    review</a></span>
                                </div>
                                ...
                                <div class="product-details-price-wrapper"><span
                                        class="money">$550.00</span><span class="product-price-old"><span
                            ...
                            <div class="product-details-bottom">
                                ...
                                <p class="product-details-tags">Tags: <a href="shop.html">Sport</a>, <a
                        ...
                        <div class="product-details-tab-content tab-content">
                            <div class="tab-pane fade show active" id="nav-desc" role="tabpanel"
                                ...
                                <p class="product-details-description">Lorem ipsum dolor sit amet, consectetur
                                    ...
                                    neque libero.</p>
                                <p class="product-details-description">Pellentesque aliquet, sem eget laoreet
                                    ultrices, ipsum metus feugiat sem, quis fermentum turpis eros eget velit.
                                    Donec ac tempus ante. Fusce ultricies massa massa. Fusce aliquam, purus eget
                                    sagittis vulputate, sapien libero hendrerit est, sed commodo augue nisi non
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="product-carousel nav-top js-product-carousel-2">
                            ...
                            <div class="mirora-product">
                                <div class="product-img"><img src="user/img/products/10-450x450.jpg"
                                                              alt="Product" class="primary-image" /><img
                                        src="user/img/products/10-10-450x450.jpg" alt="Product"
                                        class="secondary-image" />
                                    <div class="product-img-overlay"><span class="product-label discount">
                                                    -7%</span><a data-toggle="modal" data-target="#productModal"
                                                                 class="btn btn-transparent btn-fullwidth btn-medium btn-style-1">Quick
                            ...
                            <div class="mirora-product">
                                <div class="product-img"><img src="user/img/products/12-450x450.jpg"
                                                              alt="Product" class="primary-image" /><img
                                        src="user/img/products/12-12-450x450.jpg" alt="Product"
                                        class="secondary-image" />
                                    <div class="product-img-overlay"><span class="product-label discount">
                                                    -7%</span><a data-toggle="modal" data-target="#productModal"
                                                                 class="btn btn-transparent btn-fullwidth btn-medium btn-style-1">Quick
                            ...
                            <div class="mirora-product">
                                <div class="product-img"><img src="assets/img/products/14-450x450.jpg"
                                                              alt="Product" class="primary-image" /><img
                                        src="assets/img/products/14-14-450x450.jpg" alt="Product"
                                        class="secondary-image" />
                                    <div class="product-img-overlay"><span class="product-label discount">
                                                    -7%</span><a data-toggle="modal" data-target="#productModal"
                                                                 class="btn btn-transparent btn-fullwidth btn-medium btn-style-1">Quick
