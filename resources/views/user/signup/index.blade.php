                ...
                <div class="col-lg-12">
                    ...
                    <div class="login-reg-box p-4 bg--2">
                        <form action="{{ route('signup') }}" method="post">
                            @csrf
                            <div class="form__group mb--20 @error('name') has-error @enderror" ><label class="form__label" for="register_email">
                                    Họ tên <span>*</span></label><input type="text" name="name" id="register_email" class="form__input form__input--2">
                                @error('name')
                            ...
                            <div class="form__group mb--20 @error('tel') has-error @enderror"><label class="form__label" for="register_email">
                                    Số điện thoại <span>*</span></label><input type="number" name="tel" id="register_email" class="form__input form__input--2">
                                @error('tel')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form__group mb--20 @error('email') has-error @enderror"><label class="form__label" for="register_email">
                                    Email <span>*</span></label><input type="text" name="email" id="register_email" class="form__input form__input--2">
                                @error('email')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
